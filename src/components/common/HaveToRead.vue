<template>
  <div class="inline">
    ...
    <el-drawer v-model="drawer" class="content" title="报名须知" :with-header="false">
      <p style="line-height: 30px"> （一）报名对象。面向四川省乐团指导教师公益培训项目的学校或愿意参加此次管乐展示活动的其他中小学、高校乐团。乐团需以学校为单位组建，中小学指挥为本校在职教师，高校指挥可以为在职教师或学生，乐团成员为本校在校学生。管乐团分为小学组、中学组和大学组。铜管乐团分为小学组和中学组。 <br />（二）乐团要求。乐团须具有完整编制，其中管乐团应包含铜管（含圆号、小号、长号、次中音号和大号等）、木管（含长笛、单簧管、萨克斯管以及打击乐器等），且具有一定的演奏水平。管乐团正式成员不少于35人，不超过65人（报名时可报预备队员5人）；铜管乐团正式成员不少于20人，不超过45人，其中打击乐不超过8人（在报名时可报预备队员3人）。每个学校限一支队伍参加一个组别，乐团名单报名确定后不得更改，如经资格审查有非本校师生的，则取消报名资格和成绩。 <br />（三）展示曲目。管乐团、铜管乐团现场展示曲目均为指定曲目和自选曲目各一首，指定曲目详见附件1。 <br />（四）视奏要求。管乐团各组别参演乐团必须在现场展示时进行视奏，并在规定时间内完成，乐团视奏成绩为5分，单独计入展示总分。没有视奏的乐团在总分里直接扣除2分。视奏乐曲将于当场抽取，铜管乐团不视奏。 <br />（五）展示时长。管乐团指定曲目、自选曲目及视奏乐曲的总展演时间为小学组不超过12分钟、中学组不超过15分钟、大学组不超过18分钟；铜管乐团指定曲目、自选曲目的总展演时长小学组、中学组均不超过10分钟。总表演时间从第一个学生上台开始到最后一个学生下台结束，每超出一分钟扣1分，超出不足1分钟扣一分。 </p>
    </el-drawer>
  </div>
</template>
