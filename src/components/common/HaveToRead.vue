 ...
 *   其余：每个学校限一支队伍参加一个组别 → 每所学校限报一支队伍，且只能参加
 *   一个组别；（在报名时可报预备队员3人）→（报名时可报预备队员3人）。
